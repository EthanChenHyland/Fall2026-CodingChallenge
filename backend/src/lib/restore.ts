...
type Snapshot = { item: Item; likes: Array<{ user_id: number; created_at: string }>; comments: Array<{ id: number; user_id: number; body: string; parent_id: number | null; created_at: string }>; cover: boolean }
