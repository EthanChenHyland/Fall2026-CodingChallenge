  ...
  return (
    <div className="legal-shell">
      ...
      <main className="legal-page">
        ...
        <section className="legal-section"><h2>How that data is used</h2><p>The data is used to sign you in, save and organize your collections, enable collaboration and messaging, show social activity, personalize recommendations from your saved interests, and enforce collection privacy and permissions. This build does not include advertising or third-party analytics SDKs, and Mosaic does not sell personal information.</p></section>
        ...
        <section className="legal-section"><h2>Your choices</h2><p>You control whether collections are private, followers-only, or public, and you can revoke sharing links and collaborator access. This build does not yet provide a self-service account deletion screen. To request deletion of an account or ask a privacy question, email <a href="mailto:ethan.b.chen@vanderbilt.edu">ethan.b.chen@vanderbilt.edu</a>.</p></section>
